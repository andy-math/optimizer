...
class _trust_region_impl:
    ...
    def stop_criteria(
        ...
        max_stall_iter: Final[Optional[int]] = self.state.opts.max_stall_iter
    ...
    def _run(self, x: ndarray) -> Trust_Region_Result:
        ...
        abstol_fval: Final[Optional[float]] = self.state.opts.abstol_fval
        while True:
            hessian_force_shake: bool
            ...
            if new_sol.fval < old_sol.fval:
                ...
                if abstol_fval is not None:
                    if self.old_fval - old_sol.fval < abstol_fval:
                        self.stall_iter += 1
                    else:
